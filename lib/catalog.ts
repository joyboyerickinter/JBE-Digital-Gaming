...
const DEMO: CatalogProduct[] = [
  { id:'demo-mlbb', name:'Mobile Legends', slug:'mlbb', icon:'M', image_path:null, active:true, sort_order:1, packages:[
  ...
  { id:'demo-pubg', name:'PUBG Mobile', slug:'pubg-mobile', icon:'P', image_path:null, active:true, sort_order:2, packages:[
  ...
  { id:'demo-magic', name:'Magic Chess', slug:'magic-chess', icon:'✦', image_path:null, active:true, sort_order:3, packages:[
  ...
  { id:'demo-chatgpt', name:'ChatGPT', slug:'chatgpt', icon:'AI', image_path:null, active:true, sort_order:4, packages:[
  ...
  { id:'demo-canva', name:'Canva', slug:'canva', icon:'C', image_path:null, active:true, sort_order:5, packages:[
  ...
  { id:'demo-engnovate', name:'Engnovate', slug:'engnovate', icon:'E', image_path:null, active:true, sort_order:6, packages:[
    {id:'eng-1',name:'Premium - 1 Month',b2c_price:60000,active:true,sort_order:1},
  ]},
  { id:'demo-outline', name:'Outline VPN', slug:'outline-vpn', icon:'VPN', image_path:null, active:true, sort_order:7, packages:[
...
export async function getCatalog(): Promise<CatalogProduct[]> {
  ...
  try {
    ...
    const { data: products, error } = await supabase
      .from('products')
      .select('id,name,slug,icon,image_path,active,sort_order,packages(id,name,active,sort_order,prices!inner(price,customer_type,active))')
      .eq('active', true)
      .order('sort_order');
